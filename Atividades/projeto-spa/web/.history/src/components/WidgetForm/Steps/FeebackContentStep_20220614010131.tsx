...
export function FeedbackContentStep({ 
    ...
    return (
        <>
            ...
            <footer className="flex gap-2 p-2 border-bg-color-zinc-100">
                <button type="button" className=" bg-zinc-800 rounded-md boder-transparent hover:bg-[#06f]">
                    <Camera className="w-6 h-5" />

                </button>

                <button type="submit" className="p-5 mb-2  rounded-md border-transparent flex-1 flex justify-center items-center bg-[#09f] hover:bg-[#06f] border-zinc-900 transition-all w-full mt-2"
