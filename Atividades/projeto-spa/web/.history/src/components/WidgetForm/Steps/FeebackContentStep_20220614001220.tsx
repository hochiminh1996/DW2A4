    ...
    return (
        <>
            ...
            <form className="my-4 w-full">
                <textarea className="min-w-[304px] w-full min-h-[112px] text-sm text-zinc-100 border-zinc-600 bg-transparent rounded-md focus:ring-[#09f]  placeholder-zinc-400 focus"></textarea>
