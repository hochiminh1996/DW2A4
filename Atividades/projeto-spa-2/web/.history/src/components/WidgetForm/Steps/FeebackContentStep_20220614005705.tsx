    ...
    return (
        <>
            ...
            <footer className="flex gap-2 mt-2 ">
                ...
                <button type="submit" className="p-2 mb-2  rounded-md border-transparent flex-1 flex justify-center items-center bg-[#09f] hover:bg-[#06f] border-zinc-900 transition-all w-full mt-"
