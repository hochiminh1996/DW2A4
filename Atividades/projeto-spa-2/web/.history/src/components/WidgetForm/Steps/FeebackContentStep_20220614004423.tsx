    ...
    return (
        <>
            ...
            <footer className="flex gap-2 mt-2">
                <button type="submit" className="flex justify-between bg-[#09f] mb-2 focus-ring-2 hover:bg-[#05f] transition-all cursors:pointer p-2 rounded-md flex-1 focus:ring-offset-2 focus:ring-offset-"
