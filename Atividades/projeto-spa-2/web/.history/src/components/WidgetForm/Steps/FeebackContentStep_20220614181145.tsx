...
export function FeedbackContentStep({
    ...
    function handleSubmitFeedback(event : FormEvent){
        ...
        console.log(screenshot, commment)
    }
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmitFeedback} className="my-4 w-full flex flex-col">
                ...
                <input type="text" className="flex flex-col mb-2 bg-transparent justify-content border-[#09f]" placeholder="Email:" onChange={event => setComment(event.target.value)}/>
